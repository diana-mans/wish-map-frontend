	...
	return (
		<div className={cls.MainPage}>
			...
			<p>
				...
				<br />
				<b>
					Именно здоровье — фундамент для счастливой жизни, а\u00A0оно напрямую зависит от питания.
				</b>
				<br />
				<br />
			...
			<img src={img3} alt='lets go' className={cls.img3} />
			<h1>
				Пожалуйста,
				<br />
				представьтесь:
			...
			<img src={img4} alt='imaging' className={cls.img4} />
			...
			{cardsArray.map((el, idx) => {
				return (
					<>
						<div className='cell' style={{ backgroundColor: el.color }}>
							{el.name}
						</div>
						<p className='wide-text'>{el.desc}</p>
						<h2 className={`${cls.add_photo_text}`} style={{ color: el.color }}>
						...
						<h2 style={{ color: el.color }}>
							Введите текст
							<br />
							для подписи
						</h2>
						<textarea
							style={{ backgroundImage: `url(${el.textarea_image})` }}
							name='desc'
							id='1'
							maxLength={90}
							onChange={(event) => {
			...
			<h1 className={cls.send_text}>
				<span>нажми,</span> чтобы активировать карту <span>и запустить процесс</span> испольнения
				желаний
			</h1>
